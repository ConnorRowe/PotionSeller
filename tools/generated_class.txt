...
public class Items : Reference
{
	...
	public static Item ELDERBERRIES = new Item("Elderberries", Item.ItemType.Reagent, Item.Rarity.Common, "elderberries", Colors.RebeccaPurple, "A berry found throughout forests all over the isles. Commonly known to help one see as a cat does.");
